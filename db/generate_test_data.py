...
exposure_sql = "INSERT INTO exposures "\
                ...
                " VALUES (%(token)s, %(observing_block_id)s, %(observing_group_id)s, %(exposure_data)s, %(attributing_agency_id)s,"\
                " %(program_id)s, %(status)s, %(created_at)s, %(updated_at)s, %(observing_component_id)s,"\
                " %(obsid)s, %(dirty)s, %(version)s, %(instrument_run_id)s)"
